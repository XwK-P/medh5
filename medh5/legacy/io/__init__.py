...
if TYPE_CHECKING:
    from medh5.legacy.io.dicom import from_dicom
    from medh5.legacy.io.nifti import from_nifti, import_seg_nifti, to_nifti
    from medh5.legacy.io.nnunetv2 import from_nnunetv2, to_nnunetv2
...
def __getattr__(name: str) -> Any:
    if name in ("from_nifti", "import_seg_nifti", "to_nifti"):
        from medh5.legacy.io import nifti as _nifti

        return getattr(_nifti, name)
    if name in ("from_nnunetv2", "to_nnunetv2"):
        from medh5.legacy.io import nnunetv2 as _nnu

        return getattr(_nnu, name)
    if name == "from_dicom":
        from medh5.legacy.io import dicom as _dicom
